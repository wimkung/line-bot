                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div style="background: #c9ffe9;
                            ...
                            <p>&nbsp;&nbsp;&nbsp;คะแนนรวม 20 - 29 คะแนน   หมายถึง     มีอาการโรคข้อเข่าเสื่อมระดับปานกลาง</p>
                        </div>
                        <br>
                        <h3><B>คำแนะนำ</B></h3>
                        <div style="background: #c1ffc1;
                            padding: 10px 0px 10px 5px; border:1px solid #f3f3f3;">
                            <p>&nbsp;&nbsp;&nbsp;ควรปรึกษาศัลยแพทย์ผู้เชี่ยวชาญกระดูกและข้อเพื่อรับการตรวจรักษา เอกซเรย์ข้อเข่า และประเมินอาการของโรค
                            </p>
                        </div>
                    </div>
                </div>
