            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <font color="#000000">เพิ่มข้อมูลบทความสุขภาพ</font></h2>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="form-group">
                            {!! Form::label('ชื่อบทความสุขภาพ') !!}
                            {!! Form::text('health_title', null, array('class'=>'form-control','placeholder'=>'ชื่อ')) !!}
                        </div>
                    </div>
                    <br><br>
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="form-group">
                            {!! Form::label('รายละเอียดบทความ') !!}
                            {!! Form::textarea('health_inform', null, array('class'=>'form-control','row'=>'5','placeholder'=>'รายละเอียด')) !!}
                        </div>
                    </div>
