            ...
            <div id="page-inner">
                <div class="row">
                    ...
                    <div class="col-md-3 col-md-offset-2">
                        <br>
                        <a href="{{url ('admin/health/create')}}" class="btn btn-success btn-lg btn-block" type="button"><span class="fa fa-plus"> เพิ่มข้อมูล</span></a>
                    </div>
                    <div class="col-md-12">
                        <hr>
                    </div>
                ...
                @foreach($healths as $health)
                    ...
                    <div class="col-md-5">
                        <h4>&nbsp;&nbsp;{{ $health->health_title}}</h4>
                    </div>

                    <div class="col-md-1 col-md-offset-1">
                        <br>
                        <a href="{{url ('admin/health/'. $health->health_id)}}" class="btn btn-primary"><span class="fa fa-book"> อ่าน</span></a>
                    </div>

                    <div class="col-md-1 col-md-offset-1">
                        <br>
                        <a href="{{url('admin/health/'.$health->health_id.'/edit')}}" class="btn btn-default"><span class="fa fa-pencil"> แก้ไข</span></a>
                        <!-- <a href="{{url('admin/health/destroy/'.$health->health_id) }}" class="btn btn-danger"><span class="fa fa-trash"> ลบ</span></a> -->
                    </div>
                    <div class="col-md-1 col-md-offset-1">
                        <br>
                        {!! Form::open(['url'=>'admin/health/'.$health->health_id,'method'=>'DELETE','class'=>'form-horizontal',
