                    ...
                    <li>
                        <a href="#"><i class="fa fa-medkit fa-2x"></i><font size="5">การดูแลสุขภาพ</font></a>
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a class="active-menu" href="{{ url('member/food') }}"><font size="4">อาหาร</font></a>
                                </li>
                                <li>
            ...
            <div id="page-inner">
                <div class="row">
                    ...
                    <div class="col-md-5 col-md-offset-2">
                        {!! Form::open(['url' => 'member/search/food', 'method' => 'get']) !!}
                            <br>
                ...
                @foreach($foods as $food)
                    ...
                    <div class="col-md-3 col-md-offset-1">   
                        <a href="{{url ('member/food/'. $food->food_id)}}" class="btn btn-primary btn-lg"><span class="fa fa-book fa-2x"> อ่าน</span></a>
                         &nbsp;
                    </div>
