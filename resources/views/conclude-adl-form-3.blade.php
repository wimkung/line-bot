                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div style="background: #c9ffe9;
                            ...
                            <p>&nbsp;&nbsp;&nbsp;คะแนนรวมตั้งแต่ 12 คะแนนขึ้นไป หมายถึง     เป็นผู้สูงอายุกลุ่มที่ 1 คือ ผู้สูงอายุที่พึ่งตนเองได้ ช่วยเหลือผู้อื่น ชุมชนและสังคมได้ (กลุ่มติดสังคม) มีผลรวมคะแนน ADL ตั้งแต่ 12 คะแนนขึ้นไป
                            </p>
                        </div>
                    </div>
                </div>
