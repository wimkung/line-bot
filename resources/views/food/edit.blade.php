                    ...
                    <li>
                        <a href="#"><i class="fa fa-medkit"></i><font size="4">การดูแลสุขภาพ</font><span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a class="active-menu" href="{{url ('admin/food')}}"><font size="3">อาหาร</font></a>
                                </li>
                                <li>
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <font color="#000000">แก้ไขข้อมูลอาหาร</font></h2>
                    </div>
                    <div class="col-md-2 col-md-offset-2">
                        <br>
                        <a href="{{url ('admin/food')}}" class="btn btn-success btn-lg btn-block" type="button"><span class="fa fa-arrow-left"> กลับสู่หน้าหลัก</span></a>
                    </div>
                    <div class="col-md-12">
                        <hr>
                    </div>
                ...
                <div class="row">
                    ...
                    {!! Form::model($food, ['method' => 'PUT', 'action'=>['AdminFoodController@update', $food->food_id]]) !!}

                    <br>
                    <div class="col-md-8 col-md-offset-2">
                        <div class="form-group">
                            {!! Form::label('ชื่อข้อมูลอาหาร') !!}
                            {!! Form::text('food_title', null, array('required', 'class'=>'form-control','placeholder'=>'ชื่อ')) !!}
                        </div>
                    </div>
                    <br><br>
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="form-group">
                            {!! Form::label('รายละเอียดข้อมูลอาหาร') !!}
                            {!! Form::textarea('food_inform', null, array('required', 'class'=>'form-control','row'=>'5','placeholder'=>'รายละเอียด')) !!}
                        </div>
                    </div>

                    <div class="col-md-8 col-md-offset-2">
                        <br>
                        <a href="{{url ('admin/food/pic/'. $food->food_id)}}" class="btn btn-default"><span class="fa fa-pencil"> แก้ไขรูปภาพ</span></a>
