            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <font color="#000000">เพิ่มข้อมูลบทความธรรมะ</font></h2>
                    </div>
                ...
                <div class="row">
                    ...
                    {!! Form::open(['url' => 'admin/dhamma', 'method' => 'post', 'files' => 'true']) !!}

                    <br>
                    <div class="col-md-8 col-md-offset-2">
                        <div class="form-group">
                            {!! Form::label('ชื่อข้อมูลบทความธรรมะ') !!}
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="form-group">
                            {!! Form::label('รายละเอียดข้อมูลบทความธรรมะ') !!}
