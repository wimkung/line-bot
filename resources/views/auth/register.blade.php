        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="{{ url('/register') }}"><i class="fa fa-registered fa-2x"></i><font size="5">สมัครสมาชิก</font></a>
                    </li>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group-lg">
                                    <input placeholder="รหัสผ่านอย่างน้อย 6 ตัว" id="password" type="password" class="form-control" name="password" required>
                        ...
                        <div class="form-group">
                            <label for="password-confirm" class="col-md-3 control-label"><h4><B>ยืนยันรหัสผ่าน</B></h4></label>
