                    ...
                    <li>
                        <a href="#"><i class="fa fa-medkit"></i><font size="4">การดูแลสุขภาพ</font><span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a class="active-menu" href="{{url ('admin/medicine')}}"><font size="3">ยาและสมุนไพรเพื่อสุขภาพ</font></a>
                                </li>
                                <li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-8">
                        &nbsp;
                        <h2 class="glyphicon glyphicon-plus" style="color:#00bfff">
                        <font color="#000000">เพิ่มข้อมูลการใช้ยาและสมุนไพรเพื่อสุขภาพ</font></h2>
                    </div>
                    <div class="col-md-2 col-md-offset-2">
                        <br>
                        <a href="{{url ('admin/medicine')}}" class="btn btn-success btn-lg btn-block" type="button"><span class="fa fa-arrow-left"> กลับสู่หน้าหลัก</span></a>
                    </div>
                    <div class="col-md-12">
                        <hr>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="form-group">
                            {!! Form::label('ชื่อข้อมูลการใช้ยาและสมุนไพรเพื่อสุขภาพ') !!}
                            {!! Form::text('medicine_title', null, array('required', 'class'=>'form-control','placeholder'=>'ชื่อ')) !!}
                        </div>
                    </div>
                    <br><br>
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="form-group">
                            {!! Form::label('รายละเอียดข้อมูลการใช้ยาและสมุนไพรเพื่อสุขภาพ') !!}
                            {!! Form::textarea('medicine_inform', null, array('required', 'class'=>'form-control','row'=>'5','placeholder'=>'รายละเอียด')) !!}
                        </div>
                    </div>
                    ...
                    <div class="col-md-2 col-md-offset-9">
                        <div class="form-group">
                            ...
                            {!! Form::submit('เพิ่มข้อมูล', array('class'=>'btn btn-primary')) !!}
                            </div>
                        </div>
                    </div>
