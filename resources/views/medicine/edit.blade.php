            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <font color="#000000">แก้ไขข้อมูลการใช้ยาและสมุนไพรเพื่อสุขภาพ</font></h2>
                    </div>
                ...
                <div class="row">
                    ...
                    {!! Form::model($medicine, ['method' => 'PUT', 'action'=>['AdminMedicineHerbController@update', $medicine->medicine_id]]) !!}
