            ...
            <div id="page-inner">
                <div class="row">
                    ...
                    <div class="col-md-5 col-md-offset-1">
                        {!! Form::open(['url' => 'user/search/exercise', 'method' => 'get']) !!}
                            <br>
                ...
                @foreach($exercises as $exercise)
                    ...
                    <div class="col-md-3 col-md-offset-1">   
                        <a href="{{url ('user/exercise/'. $exercise->exercise_id)}}" class="btn btn-primary btn-lg"><span class="fa fa-book fa-2x"> อ่าน</span></a>
                         &nbsp;
                    </div>
