    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="row">
                {!! Form::model($exercise, ['method' => 'PUT', 'files' => 'true', 'action'=>['AdminExercisePicController@update', $exercise->exercise_id]]) !!}
                    <br>
                ...
                <div class="row">
                    <!-- <div class="col-md-5 col-md-offset-1"> -->
                            ...
                            @foreach ($exercises as $exercise)
                                <div class="col-md-5 col-md-offset-1">
                                    <img class="slide-image" src="{{asset('images/resize_exercise/'.$exercise->exercise_pic_file) }}" width="300"alt="">
                                </div>

                                <div class="col-md-2 col-md-offset-3">
                                <br><br><br>
                                {!! Form::open(['url'=>'admin/exercise/pic/destroy/'.$exercise->exercise_pic_id,'method'=>'DELETE','class'=>'form-horizontal',
