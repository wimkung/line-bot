    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="row">
                {!! Form::model($dhamma, ['method' => 'PUT', 'files' => 'true', 'action'=>['AdminDhammaPicController@update', $dhamma->dhamma_id]]) !!}
                    <br>
                ...
                <div class="row">
                    <!-- <div class="col-md-5 col-md-offset-1"> -->
                            ...
                            @foreach ($dhammas as $dhamma)
                                <div class="col-md-5 col-md-offset-1">
                                    <img class="slide-image" src="{{asset('images/resize_dhamma/'.$dhamma->dhamma_pic_file) }}" width="300"alt="">
                                </div>

                                <div class="col-md-2 col-md-offset-3">
                                <br><br><br>
                                {!! Form::open(['url'=>'admin/dhamma/pic/destroy/'.$dhamma->dhamma_pic_id,'method'=>'DELETE','class'=>'form-horizontal',
