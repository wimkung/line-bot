            ...
            <div id="page-inner">
                <div class="row">
                    ...
                    <div class="col-md-5 col-md-offset-2">
                        {!! Form::open(['url' => 'user/search/dhamma', 'method' => 'get']) !!}
                            <br>
                ...
                @foreach($dhammas as $dhamma)
                    ...
                    <div class="col-md-3 col-md-offset-1">   
                        <a href="{{url ('user/dhamma/'. $dhamma->dhamma_id)}}" class="btn btn-primary btn-lg"><span class="fa fa-book fa-2x"> อ่าน</span></a>
                         &nbsp;
                    </div>
