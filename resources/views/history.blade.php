    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="{{ url('member/evaluation') }}"><i class="glyphicon glyphicon-list-alt fa-2x"></i><font size="5">แบบประเมินสุขภาพ</font></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a class="active-menu" href="{{ url('member/history') }}"><font size="4"> ประวัติการทำแบบประเมิน</font></a>
                                </li>
                            </ul>
                    </li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-6">
                        <h1><B>&nbsp; ประวัติการทำแบบประเมิน</B></h1>
                    </div>
                ...
                @foreach($historys as $history)
                    <div class="col-md-12">
                        <br>
                        <h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-list-alt fa-2x" style="color:#00bfff">
                        <font color="#000"><B>{{ $history->form_title}}</B></font>
                        </span></h5>
                    </div>

                    <div class="col-md-12">
                        <br>
                        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-time" style="color:#00bfff"></span> &nbsp;วันที่ทำแบบประเมิน {{ $history->created_at }}</p>
                    </div>
                
                    <div class="col-md-12">
                        <br>
                        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-plus-square-o" style="color:#00bfff"></span> &nbsp;คะแนนรวม {{$history->total_score}} คะแนน</p>
                        <br>
                    </div>
