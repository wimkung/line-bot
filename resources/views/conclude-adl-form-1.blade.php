    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-7">
                        <h2><B>&nbsp; ผลการทำแบบประเมินความสามารถในการทำกิจวัตรประจำวัน</B></h2>
                    </div>
                    <div class="col-md-4 col-md-offset-1">
                        <br>
                        <a href="{{url ('member/adl/form')}}" class="btn btn-success btn-lg" type="button"><span class="fa fa-arrow-left fa-2x"> กลับสู่หน้าหลัก</span></a>
                    </div>
                    <div class="col-md-12">
                        <hr>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div style="background: #c9ffe9;
                            ...
                            <p>&nbsp;&nbsp;&nbsp; คะแนนรวม 0 - 4 คะแนน หมายถึง     เป็นผู้สูงอายุกลุ่มที่ 3 คือ ผู้สูงอายุกลุ่มที่พึ่งตนเองไม่ได้ ช่วยเหลือตนเองไม่ได้ พิการ หรือทุพพลภาพ (กลุ่มติดเตียง) ซึ่งมีผลรวมคะแนน ADL อยู่ในช่วง 0 - 4 คะแนน
                            </p>
                        </div>
                    </div>
                </div>
