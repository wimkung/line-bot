    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-8">
                        <h2>&nbsp;&nbsp;เรื่องราวประสบการณ์ชีวิต</h2>
                    </div>
                    <div class="col-md-12">
                        <hr>
                    </div>
                ...
                <div class="row">
                    ...
                    <!-- <div class="col-md-1 col-md-offset-1">
                        <br><br>
                        <a href="{{url('admin/share/destroy/'.$share->share_id) }}" class="btn btn-danger"><span class="fa fa-trash"> ลบ</span></a>
                    </div> -->
                    
                    <div class="col-md-1 col-md-offset-1">
                        <br><br>
                        {!! Form::open(['url'=>'admin/share/destroy/'.$share->share_id,'method'=>'DELETE','class'=>'form-horizontal',
