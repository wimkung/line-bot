                    ...
                    <li>
                        <a href="#"><i class="fa fa-medkit fa-2x"></i><font size="5">การดูแลสุขภาพ</font></a>
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a class="active-menu" href="{{ url('user/medicine') }}"><font size="4">ยาและสมุนไพรเพื่อสุขภาพ</font></a>
                                </li>
                                <li>
            ...
            <div id="page-inner">
                <div class="row">
                    ...
                    <div class="col-md-4 col-md-offset-2">
                        <br>
                        <a href="{{url ('user/medicine')}}" class="btn btn-success btn-lg" type="button"><span class="fa fa-arrow-left fa-2x"> กลับสู่หน้าหลัก</span></a>
                    </div>
                    <div class="col-md-12">
                        <br>
                        <hr>
                ...
                @foreach($medicine_searches as $medicine_search)
                    ...
                    <div class="col-md-3 col-md-offset-1">
                        <a href="{{url ('user/medicine/'. $medicine_search->medicine_id)}}" class="btn btn-primary btn-lg"><span class="fa fa-book fa-2x"> อ่าน</span></a>
                         &nbsp;
                    </div>
