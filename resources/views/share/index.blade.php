        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-5">
                        <br>
                        <h1><B>&nbsp; เรื่องราวประสบการณ์ชีวิต</B></h1>
                    </div>
                    <div class="col-md-5 col-md-offset-2">
                        <br><br>
                        <a href="{{url ('member/share/create')}}" class="btn btn-success btn-lg" type="button"><span class="fa fa-share-alt fa-2x"> แบ่งปันประสบการณ์</span></a>
                    </div>
                    <div class="col-md-12">
                        <br>
                        <hr>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-md-offset-2">
                        <br>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="{{url ('member/share/'. $share->share_id)}}" class="btn btn-primary btn-lg"><span class="fa fa-book fa-2x"> อ่าน</span></a>
                    </div>
