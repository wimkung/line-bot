            ...
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <h3><B>การแปลผล</B></h3></font>
                        <div style="background: #d0f2fe;
                            padding: 10px 0px 10px 0px; border:1px solid #f3f3f3;">
                            <p>&nbsp;&nbsp;&nbsp;ค่าดัชนีมวลกายมีค่าน้อยกว่า 18.50 หมายถึง  น้ำหนักน้อยกว่ามาตรฐาน คือ มีน้ำหนักน้อยหรือผอม</p>
                        </div>
                            <br>
                            <h3><B>คำแนะนำ</B></h3>
                        <div style="background: #c1ffc1;
                            padding: 10px 0px 10px 7px; border:1px solid #f3f3f3;">
                            <p>&nbsp;&nbsp;&nbsp;1. ควรกินอาหารให้หลากหลายครบ 5 หมู่ในสัดส่วนที่เหมาะสมและปริมาณมากขึ้น โดยเพิ่มอาหารประเภทที่ให้พลังงานมากขึ้น เช่น ไขมัน แป้ง ข้าว เนื้อสัตว์ นม
                            <br><br>
