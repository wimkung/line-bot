    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-7">
                        <h2><B>&nbsp;ผลการทำแบบประเมินโรคซึมเศร้า 9 คำถาม (9Q)</B></h2>
                    </div>
                    <div class="col-md-4 col-md-offset-1">
                        <br>
                        <a href="{{url ('member/depress/form')}}" class="btn btn-success btn-lg" type="button"><span class="fa fa-arrow-left fa-2x"> กลับสู่หน้าหลัก</span></a>
                    </div>
                    <div class="col-md-12">
                        <hr>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div style="background: #c9ffe9;
                            ...
                            <p>&nbsp;&nbsp;&nbsp;ผลรวมคะแนน < 7 คะแนน หมายถึง     ไม่มีอาการของโรคซึมเศร้าหรือมีอาการของโรคซึมเศร้าระดับน้อยมาก</p>
                        </div>
                            <br>
                        <h3><B>คำแนะนำ</B></h3>
                        <div style="background: #c1ffc1;
                            padding: 10px 0px 10px 5px; border:1px solid #f3f3f3;">
                            <p>&nbsp;&nbsp;&nbsp;1. แนะนำให้ออกกำลังกาย 30 - 45 นาที อย่างน้อยสัปดาห์ละ 3 ครั้ง ยกเว้นในผู้ที่มีข้อจำกัดห้าม<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ออกกำลังกาย
                            <br>&nbsp;&nbsp;&nbsp;2. แนะนำให้สำรวจ/ประเมินโรคซึมเศร้าด้วยตนเองด้วยแบบคัดกรองโรคซึมเศร้า 2 คำถาม (2Q) <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;เมื่อพบว่า ผลมีแนวโน้มป่วยเป็นโรคซึมเศร้า ให้มาพบบุคลากรสาธารณสุขเพื่อประเมินโรคซึมเศร้า<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;อีกครั้ง
                            </p>
                    </div>
                </div>
            {!! Form::close() !!}
