            ...
            <div id="page-inner">
                <div class="row">
                    ...
                    <div class="col-md-5 col-md-offset-2">
                        {!! Form::open(['url' => 'user/search/health', 'method' => 'get',]) !!}
                            <br>
                ...
                @foreach($healths as $health)
                    ...
                    <div class="col-md-3 col-md-offset-1">
                        <a href="{{url ('user/health/'. $health->health_id)}}" class="btn btn-primary btn-lg"><span class="fa fa-book fa-2x"> อ่าน</span></a>
                         &nbsp;
                    </div>
