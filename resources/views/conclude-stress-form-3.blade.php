            ...
            <div id="page-inner">
                <div class="row">
                    ...
                    <div class="col-md-4 col-md-offset-1">
                        <br>
                        <a href="{{url ('member/stress/form')}}" class="btn btn-success btn-lg" type="button"><span class="fa fa-arrow-left fa-2x"> กลับสู่หน้าหลัก</span></a>
                    </div>
                    <div class="col-md-12">
                        <hr>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div style="background: #c9ffe9;
                            ...
                            <p>&nbsp;&nbsp;&nbsp; คะแนนรวม 8 คะแนนขึ้นไป หมายถึง มีความเครียดสูงในระดับที่อาจจะส่งผลเสียต่อร่างกาย เช่น ปวดหัว 
                            <br>ปวดหลัง นอนไม่หลับ ฯลฯ 
                            </p>
                        </div>
                        <br>
                        <h3><B>คำแนะนำ</B></h3>
                        <div style="background: #c1ffc1;
                            padding: 10px 0px 10px 5px; border:1px solid #f3f3f3;">
                            <p>&nbsp;&nbsp;&nbsp;ต้องได้รับคำปรึกษาจากบุคลากรสาธารณสุข เพื่อค้นหาสาเหตุที่ทำให้เกิดความเครียดและหาแนวทางแก้ไข</p>
                        </div>
                    </div>
                </div>
            {!! Form::close() !!}
