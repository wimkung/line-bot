...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                @foreach ($exercise_text as $exercise)
                    @if($loop->first)
                    <div class="col-md-8">
                        <br>
                        <h4><B>&nbsp;&nbsp;{{$exercise->exercise_title}}</B></h4>
                    </div>
                    @endif
                @endforeach
                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            @foreach ($exercises as $exercise)
                                ...
                                <div class="item active">
                                    <img class="slide-image" src="{{asset('images/resize_exercise/'.$exercise->exercise_pic_file) }}" alt="">
                                </div>
                                @endif
                            @endforeach
                    ...
                    @foreach ($exercise_text as $exercise)
                        @if ($loop->first) 
                            <div class="col-md-8 col-md-offset-2">
                                <br>
                                <p>
                                <?php $myStringWithANewLine = "$exercise->exercise_inform";
