    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-7">
                        <h2>&nbsp;การออกกำลังกายสำหรับผู้สูงอายุ</h2>
                    </div>
                    <div class="col-md-3 col-md-offset-2">
                        <br>
                        <a href="{{url ('admin/exercise/create')}}" class="btn btn-success btn-lg btn-block" type="button"><span class="fa fa-plus"> เพิ่มข้อมูล</span></a>
                    </div>
                    <div class="col-md-12">
                        <hr>
                    </div>
                ...
                @foreach($exercises as $exercise)
                    ...
                    <div class="col-md-1 col-md-offset-1">
                        <br>
                        <a href="{{url ('admin/exercise/'. $exercise->exercise_id)}}" class="btn btn-primary"><span class="fa fa-book"> อ่าน</span></a>
                    </div>

                    <div class="col-md-1 col-md-offset-1">
                        <br>
                        <a href="{{url('admin/exercise/'.$exercise->exercise_id.'/edit')}}" class="btn btn-default"><span class="fa fa-pencil"> แก้ไข</span></a>
                    </div>

                    <div class="col-md-1 col-md-offset-1">
                        <br>
                        {!! Form::open(['url'=>'admin/exercise/'.$exercise->exercise_id,'method'=>'DELETE','class'=>'form-horizontal',
