    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-7">
                        <h2><B>&nbsp;ผลการทำแบบประเมินระดับความรุนแรง<br>ของโรคข้อเข่าเสื่อม</B></h2>
                    </div>
                    <div class="col-md-4 col-md-offset-1">
                        <br>
                        <a href="{{url ('member/knee/form')}}" class="btn btn-success btn-lg" type="button"><span class="fa fa-arrow-left fa-2x"> กลับสู่หน้าหลัก</span></a>
                    </div>
                    <div class="col-md-12">
                        <hr>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div style="background: #c9ffe9;
                            ...
                            <p>&nbsp;&nbsp;&nbsp;คะแนนรวม 30 - 39 คะแนน หมายถึง 
                            พบเริ่มมีอาการของโรคข้อเข่าเสื่อม</p>
                        </div>
                        <br>
                        <h3><B>คำแนะนำ</B></h3>
                        <div style="background: #c1ffc1;
                            padding: 10px 0px 10px 5px; border:1px solid #f3f3f3;">
                            <p>&nbsp;&nbsp;&nbsp;ควรได้รับคำแนะนำจากศัลยแพทย์ผู้เชี่ยวชาญกระดูกและข้อเรื่องการออกกำลังกายอย่างเหมาะสม การควบคุมน้ำหนักเพื่อไม่ให้อ้วน หลีกเลี่ยงท่าหรือกิจกรรมที่จะทำให้เกิดอาการและความรุนแรงของโรคมากขึ้น และการประเมินระดับอาการของโรค
                            </p>
                        </div>
                    </div>
                </div>
