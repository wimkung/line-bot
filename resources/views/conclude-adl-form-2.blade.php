                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div style="background: #c9ffe9;
                            ...
                            <p>&nbsp;&nbsp;&nbsp;คะแนนรวม 5 - 11 คะแนน หมายถึง     เป็นผู้สูงอายุกลุ่มที่ 2 คือ ผู้สูงอายุที่ดูแลตนเองได้บ้าง ช่วยเหลือตนเองได้บ้าง (กลุ่มติดบ้าน) ซึ่งมีผลรวมคะแนน ADL อยู่ในช่วง 5 – 11 คะแนน
                            </p>
                        </div>
                    </div>
                </div>
