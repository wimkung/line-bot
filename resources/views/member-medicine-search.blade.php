    ...
    <div id="wrapper">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-medkit fa-2x"></i><font size="5">การดูแลสุขภาพ</font></a>
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a class="active-menu" href="{{ url('member/medicine') }}"><font size="4">ยาและสมุนไพรเพื่อสุขภาพ</font></a>
                                </li>
                                <li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-6">
                        <h2><B>&nbsp; การใช้ยาและสมุนไพรเพื่อสุขภาพ</B></h2>
                    </div>
                    <div class="col-md-4 col-md-offset-2">
                        <br>
                        <a href="{{url ('member/medicine')}}" class="btn btn-success btn-lg" type="button"><span class="fa fa-arrow-left fa-2x"> กลับสู่หน้าหลัก</span></a>
                    </div>
                    <div class="col-md-12">
                        <br>
                        <hr>
                ...
                <div class="row">
                @foreach($medicine_searches as $medicine_search)
                    <div class="col-md-1">
                        <br>
                    ...
                    <div class="col-md-7">
                        <h3>&nbsp;{{$medicine_search->medicine_title}}</h3>
                    </div>

                    <div class="col-md-3 col-md-offset-1">
                        <a href="{{url ('member/medicine/'. $medicine_search->medicine_id)}}" class="btn btn-primary btn-lg"><span class="fa fa-book fa-2x"> อ่าน</span></a>
                         &nbsp;
                    </div>
                ...
                <div class="row">
                    <div class="text-center">
                        <ul class="pagination">
                            {{ $medicine_searches->appends(Request::only('search'))->links() }}
                        </ul>
                    </div>
                </div>
            </div> <!-- /. PAGE INNER  -->
