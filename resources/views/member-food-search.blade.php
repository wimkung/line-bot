            ...
            <div id="page-inner">
                <div class="row">
                    ...
                    <div class="col-md-4 col-md-offset-2">
                        <br>
                        <a href="{{url ('member/food')}}" class="btn btn-success btn-lg" type="button"><span class="fa fa-arrow-left fa-2x"> กลับสู่หน้าหลัก</span></a>
                    </div>
                    <div class="col-md-12">
                        <br>
                        <hr>
                ...
                @foreach($food_searches as $food_search)
                    ...
                    <div class="col-md-3 col-md-offset-1">
                        <a href="{{url ('member/food/'. $food_search->food_id)}}" class="btn btn-primary btn-lg"><span class="fa fa-book fa-2x"> อ่าน</span></a>
                         &nbsp;
                    </div>
