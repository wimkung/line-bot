    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                {!! Form::model($food, ['method' => 'PUT', 'files' => 'true', 'action'=>['AdminFoodPicController@update', $food->food_id]]) !!}

                 <!-- {!! Form::open(['url' => 'admin/food/editpic', 'method' => 'post', 'files' => 'true']) !!} -->
                    <br>
                ...
                <div class="row">            
                    @foreach ($foods as $food)
                        <div class="col-md-5 col-md-offset-1">
                            <img class="slide-image" src="{{asset('images/resize_food/'.$food->food_pic_file) }}" width="300" alt="">
                        </div>

                        <div class="col-md-2 col-md-offset-3">
                            <br><br><br>
                            {!! Form::open(['url'=>'admin/food/pic/destroy/'.$food->food_pic_id,'method'=>'DELETE','class'=>'form-horizontal',
