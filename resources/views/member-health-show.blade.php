...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                @foreach ($health_text as $health)
                <div class="row">
                    @if($loop->first)
                    <div class="col-md-6">
                        <br>
                        <h3><B>&nbsp;&nbsp;{{$health->health_title}}</B></h3>
                    </div>
                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            @foreach ($healths as $health)
                                ...
                                <div class="item active">
                                    <img class="slide-image" src="{{asset('images/resize/'.$health->health_pic_file) }}" alt="">
                                </div>
                                @endif
                            @endforeach
                    ...
                    @foreach ($health_text as $health)
                        @if ($loop->first) 
                            <div class="col-md-8 col-md-offset-2">
                                <br>
                                <p>
                                <?php $myStringWithANewLine ="$health->health_inform";
