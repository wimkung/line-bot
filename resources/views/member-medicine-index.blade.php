            ...
            <div id="page-inner">
                <div class="row">
                    ...
                    <div class="col-md-5 col-md-offset-1">
                        {!! Form::open(['url' => 'member/search/medicine', 'method' => 'get']) !!}
                            <br>
                            <div class="input-group">
                                {!! Form::text('search', null, array('required','class'=>'form-control','placeholder'=>'คำที่ต้องการค้นหา')) !!}
                ...
                @foreach($medicines as $medicine)
                    ...
                    <div class="col-md-7">
                        <h3>&nbsp;{{$medicine->medicine_title}}</h3>
                    </div>

                    <div class="col-md-3 col-md-offset-1">   
                        <a href="{{url ('member/medicine/'. $medicine->medicine_id)}}" class="btn btn-primary btn-lg"><span class="fa fa-book fa-2x"> อ่าน</span></a>
                         &nbsp;
                    </div>
