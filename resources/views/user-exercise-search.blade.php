                    ...
                    <li>
                        <a href="#"><i class="fa fa-medkit fa-2x"></i><font size="5">การดูแลสุขภาพ</font></a>
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a class="active-menu" href="{{ url('user/exercise') }}"><font size="4">การออกกำลังกาย</font></a>
                                </li>
                                <li>
            ...
            <div id="page-inner">
                <div class="row">
                    ...
                    <div class="col-md-4 col-md-offset-2">
                        <br>
                        <a href="{{url ('user/exercise')}}" class="btn btn-success btn-lg" type="button"><span class="fa fa-arrow-left fa-2x"> กลับสู่หน้าหลัก</span></a>
                    </div>
                    <div class="col-md-12">
                        <br>
                        <hr>
                ...
                @foreach($exercise_searches as $exercise_search)
                    ...
                    <div class="col-md-3 col-md-offset-1">
                        <a href="{{url ('user/exercise/'. $exercise_search->exercise_id)}}" class="btn btn-primary btn-lg"><span class="fa fa-book fa-2x"> อ่าน</span></a>
                         &nbsp;
                    </div>
