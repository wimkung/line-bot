    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="row">
                {!! Form::model($medicine, ['method' => 'PUT', 'files' => 'true', 'action'=>['AdminMedicineHerbPicController@update', $medicine->medicine_id]]) !!}
                    <br>
                ...
                <div class="row">
                    <!-- <div class="col-md-5 col-md-offset-1"> -->
                            ...
                            @foreach ($medicines as $medicine)
                                <div class="col-md-5 col-md-offset-1">
                                    <img class="slide-image" src="{{asset('images/resize_medicine/'.$medicine->medicine_pic_file) }}" width="300"alt="">
                                </div>

                                <div class="col-md-2 col-md-offset-3">
                                <br><br><br>
                                {!! Form::open(['url'=>'admin/medicine/pic/destroy/'.$medicine->medicine_pic_id,'method'=>'DELETE','class'=>'form-horizontal',
