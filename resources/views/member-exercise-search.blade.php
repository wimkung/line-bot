    ...
    <div id="wrapper">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-medkit fa-2x"></i><font size="5">การดูแลสุขภาพ</font></a>
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a class="active-menu" href="{{ url('member/exercise') }}"><font size="4">การออกกำลังกาย</font></a>
                                </li>
                                <li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-6">
                        <h2><B>&nbsp; การออกกำลังกายสำหรับผู้สูงอายุ</B></h2>
                    </div>
                    <div class="col-md-4 col-md-offset-2">
                        <br>
                        <a href="{{url ('member/exercise')}}" class="btn btn-success btn-lg" type="button"><span class="fa fa-arrow-left fa-2x"> กลับสู่หน้าหลัก</span></a>
                    </div>
                    <div class="col-md-12">
                        <br>
                        <hr>
                ...
                <div class="row">
                @foreach($exercise_searches as $exercise_search)
                    <div class="col-md-1">
                        <br>
                    ...
                    <div class="col-md-7">
                        <h3>&nbsp;{{$exercise_search->exercise_title}}</h3>
                    </div>

                    <div class="col-md-3 col-md-offset-1">
                        <a href="{{url ('member/exercise/'. $exercise_search->exercise_id)}}" class="btn btn-primary btn-lg"><span class="fa fa-book fa-2x"> อ่าน</span></a>
                         &nbsp;
                    </div>
                ...
                <div class="row">
                    <div class="text-center">
                        <ul class="pagination">
                            {{ $exercise_searches->appends(Request::only('search'))->links() }}
                        </ul>
                    </div>
                </div>
            </div> <!-- /. PAGE INNER  -->
