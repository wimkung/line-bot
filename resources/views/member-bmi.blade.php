            ...
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <div style="background: #c9ffe9; padding: 10px 0px 10px 20px; border:5px solid #f3f3f3;">
                ...
                <div class="row">
                   {!! Form::open(['action' => 'MemberBmiController@calculate']) !!}
                ...
                <div class="row">
                    <div class="col-md-3 col-md-offset-1">
                        <div style="background: #dcfff1; padding: 5px 0px 20px 20px; border:5px solid #f3f3f3;">
